...
class DetalheImgPageINPE extends StatefulWidget {
  final Map<String, dynamic> data;
  final Uint8List? imageBytes;

  const DetalheImgPageINPE({super.key, required this.data, this.imageBytes});

  @override
  _DetalheImgPageINPEState createState() => _DetalheImgPageINPEState();
}

class _DetalheImgPageINPEState extends State<DetalheImgPageINPE> {
