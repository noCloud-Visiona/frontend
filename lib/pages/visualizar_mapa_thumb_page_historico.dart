...
class VisualizarMapaThumbHistorico extends StatefulWidget {
  final Map<String, dynamic> featureData;

  const VisualizarMapaThumbHistorico({
    Key? key,
    required this.featureData,
  }) : super(key: key);

  @override
  _VisualizarMapaThumbStateHistorico createState() => _VisualizarMapaThumbStateHistorico();
}

class _VisualizarMapaThumbStateHistorico extends State<VisualizarMapaThumbHistorico> {
  ...
  void initState() {
    super.initState();
    _thumbnails['Imagem Original'] = widget.featureData['img_tratada'];
    _thumbnails['Nuvem'] = widget.featureData['thumbnail_nuvem_url'];
    _thumbnails['Sombra'] = widget.featureData['thumbnail_sombra_url'];
    _thumbnails['Imagem Processada'] = widget.featureData['img_tratada'];
    _thumbnails['Sem Nuvem'] = widget.featureData['thumbnail_sem_nuvem_url'];
    _thumbnails['Sem Sombra'] = widget.featureData['thumbnail_sem_sombra_url'];
  }
